 ...
 */
class AreaOfSpecialty extends \project\AdminBundle\Entity\AreaOfSpecialty implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'project\\AdminBundle\\Entity\\AreaOfSpecialty' . "\0" . 'id', '' . "\0" . 'project\\AdminBundle\\Entity\\AreaOfSpecialty' . "\0" . 'name', 'subArea', 'users');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AreaOfSpecialty $proxy) {
