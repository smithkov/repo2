 ...
 */
class LGA extends \project\AdminBundle\Entity\LGA implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'project\\AdminBundle\\Entity\\LGA' . "\0" . 'id', '' . "\0" . 'project\\AdminBundle\\Entity\\LGA' . "\0" . 'name', 'state', 'users');
        }
