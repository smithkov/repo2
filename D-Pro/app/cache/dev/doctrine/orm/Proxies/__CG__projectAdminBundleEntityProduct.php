 ...
 */
class Product extends \project\AdminBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'project\\AdminBundle\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'project\\AdminBundle\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'project\\AdminBundle\\Entity\\Product' . "\0" . 'description', '' . "\0" . 'project\\AdminBundle\\Entity\\Product' . "\0" . 'price', 'productImages', 'user');
        }
