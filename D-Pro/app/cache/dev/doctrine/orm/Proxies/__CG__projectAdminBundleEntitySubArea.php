 ...
 */
class SubArea extends \project\AdminBundle\Entity\SubArea implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'project\\AdminBundle\\Entity\\SubArea' . "\0" . 'id', '' . "\0" . 'project\\AdminBundle\\Entity\\SubArea' . "\0" . 'name', 'area', 'areaOfSpecialties');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubArea $proxy) {
    ...
    public function addAreaOfSpecialty(\project\AdminBundle\Entity\AreaOfSpecialty $areaOfSpecialties)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAreaOfSpecialty', array($areaOfSpecialties));

        return parent::addAreaOfSpecialty($areaOfSpecialties);
    }
    ...
    public function removeAreaOfSpecialty(\project\AdminBundle\Entity\AreaOfSpecialty $areaOfSpecialties)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAreaOfSpecialty', array($areaOfSpecialties));

        return parent::removeAreaOfSpecialty($areaOfSpecialties);
    }
    ...
    public function getAreaOfSpecialties()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAreaOfSpecialties', array());

        return parent::getAreaOfSpecialties();
    }
